...
$('#loadAnalysisBtn').on('click', function (e) {
    ...
    $('#reportYear, #reportClassIdNew').on('change', function () {
        ...
        if (year && classId) {
            // Load exams
            $.post('reports/functions.php', { action: 'get_exams_for_class_and_year', class_id: classId, year: year }, function (response) {
    ...
    $('#transcriptYear, #transcriptClassId').on('change', function () {
        ...
        if (year && classId) {
            // Load terms
            $.post('reports/functions.php', { action: 'get_terms_for_class_and_year', class_id: classId, year: year }, function (response) {
    ...
    $('#schoolYear').on('change', function () {
        ...
        if (year) {
            ...
            $.post('reports/functions.php', { action: 'get_exams_by_year', year: year }, function (response) {
    ...
    $('#schoolExamId').on('change', function () {
        ...
        if (year && examName && term) {
            ...
            $.post('reports/functions.php', { action: 'get_classes_by_exam', year: year, exam_name: examName, term: term }, function (response) {
    ...
    $('#classListClassId').on('change', function () {
        ...
        if (classId) {
            ...
            // Load subjects
            $.post('reports/functions.php', { action: 'get_subjects_for_class', class_id: classId }, function (response) {
