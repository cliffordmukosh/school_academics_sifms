...
<head>
    ...
    <style>
        ...
        .examreport_student_row {
            display: flex;
            flex-wrap: nowrap !important;
            gap: 6px;
        }

        .examreport_student_row .card {
            flex: 1;
            border: 1px solid #0d6efd;
        }

        .examreport_student_row .card-body {
            padding: 6px;
            font-size: 12px;
        }
...
<body>
    ...
    ");
        ...
        // Teachers
        $teacher_stream_id = $agg['stream_id'] ?? 0;
    ...
    ?>
        ...
        <div class="examreport_container">
            ...
            <div class="examreport_student_row mb-3">
                <div class="card h-100 flex-fill">
                    <div class="card-body d-flex align-items-center">
                        <img src="<?php echo htmlspecialchars($profile_picture); ?>" class="examreport_profile_pic me-3" />
                        <div>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($sub_agg['subject_grade'] ?? '—'); ?></td>
                            <td class="remarks-col"><?php echo htmlspecialchars($sub_agg['remark_text'] ?? '—'); ?></td>
            ...
            <div class="examreport_remarks mb-2">
                <p class="mb-1"><strong>Class Teacher:</strong> <?php echo htmlspecialchars($agg['class_teacher_remark'] ?? '—'); ?></p>
                <p class="mb-0"><strong>Principal:</strong> <?php echo htmlspecialchars($agg['remark_text'] ?? '—'); ?></p>
            </div>
