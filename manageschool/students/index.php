...
<div class="content">
    <div class="container-fluid">
        <div class="container py-4">
            ...
            <div class="modal fade" id="addCustomGroupModal" tabindex="-1">
                <div class="modal-dialog modal-xl modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title"><i class="bi bi-plus-circle me-2"></i> Add New Custom Group</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                        </div>
                        <div class="modal-body">
                            <form id="addCustomGroupForm">
                                <div class="row g-3">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <label class="form-label">Class <span class="text-danger">*</span></label>
                                        <select class="form-select" name="class_id" id="addGroupClassSelect" required>
                                            <option value="">Select Class</option>
                                            <?php foreach ($classes as $class): ?>
                                                <option value="<?php echo $class['class_id']; ?>">
                                                    <?php echo htmlspecialchars($class['form_name']); ?>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <textarea class="form-control" name="description" rows="2" placeholder="Enter group description"></textarea>
                                    </div>
                                </div>

                                <div class="row g-3 mt-3">
                                    <div class="col-md-6" id="addGroupSubjectsSection" style="display: none;">
                                        ...
                                        <div class="border p-3 rounded" style="max-height: 280px; overflow-y: auto;">
                                            <div id="addGroupSubjectsList" class="row g-2"></div>
                                        </div>
                                        <div class="invalid-feedback mt-1" id="addSubjectsError" style="display:none;">
                                    ...
                                    <div class="col-md-6" id="addGroupStudentsSection" style="display: none;">
                                        ...
                                        <div class="border p-3 rounded" style="max-height: 280px; overflow-y: auto;">
                                            ...
                                            <div id="addGroupStudentsList" class="row g-2"></div>
                                        </div>
                                        <div class="invalid-feedback mt-1" id="addStudentsError" style="display:none;">
                                ...
                                <div class="d-flex justify-content-end mt-4">
                                    <button type="submit" class="btn btn-success px-4">Create Group</button>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <div class="modal fade" id="editCustomGroupModal" tabindex="-1">
                <div class="modal-dialog modal-xl modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title"><i class="bi bi-pencil me-2"></i> Edit Custom Group</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                        </div>
                        <div class="modal-body">
                            <form id="editCustomGroupForm">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-4">
                                        <label class="form-label">Class <span class="text-danger">*</span></label>
                                        <select class="form-select" name="class_id" id="editGroupClassSelect" required>
                                            <option value="">Select Class</option>
                                            <?php foreach ($classes as $class): ?>
                                                <option value="<?php echo $class['class_id']; ?>">
                                                    <?php echo htmlspecialchars($class['form_name']); ?>
                                ...
                                <div class="row g-3 mt-3">
                                    <div class="col-md-6" id="editGroupSubjectsSection">
                                        <label class="form-label">Select Subjects <span class="text-danger">*</span></label>
                                        <div class="border p-3 rounded" style="max-height: 280px; overflow-y: auto;">
                                            <div id="editGroupSubjectsList" class="row g-2"></div>
                                        </div>
                                        <div class="invalid-feedback mt-1" id="editSubjectsError" style="display:none;">
                                            Please select at least one subject
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6" id="editGroupStudentsSection">
                                        ...
                                        <div class="border p-3 rounded" style="max-height: 280px; overflow-y: auto;">
                                            ...
                                            <div id="editGroupStudentsList" class="row g-2"></div>
                                        </div>
                                        <div class="invalid-feedback mt-1" id="editStudentsError" style="display:none;">
                                            Please select at least one student
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="modal fade" id="manageCustomGroupsModal" tabindex="-1">
                <div class="modal-dialog modal-xl modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title"><i class="bi bi-gear me-2"></i> Manage Custom Groups</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                        </div>
                        <div class="modal-body">
                            <table class="table table-striped table-hover" id="customGroupsTable">
                                <thead class="table-dark">
                                    <tr>
                                        <th>#</th>
                                        <th>Group Name</th>
            ...
            <!-- NEW: View Students in Group Modal -->
            <div class="modal fade" id="viewGroupStudentsModal" tabindex="-1">
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">
                                <i class="bi bi-people-fill me-2"></i> Students in Group: <span id="viewGroupNameDisplay"></span>
                            </h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                        </div>
                        <div class="modal-body">
                            <div class="border p-3 rounded bg-light" style="max-height: 400px; overflow-y: auto;">
                                <ul class="list-group list-group-flush" id="viewGroupStudentsList"></ul>
                            </div>
                            <div id="noStudentsMessage" class="text-center text-muted py-5 d-none">
                                <i class="bi bi-person-x display-4"></i>
                                <p class="mt-3">No students assigned to this group yet.</p>
                            </div>
                        </div>
...
<script>
    ...
    function fetchSubjectsByClass(classId, selectElement) {
        ajaxDebug({
            url: 'students/functions.php',
            method: 'POST',
            data: {
                action: 'get_subjects_by_class',
                class_id: classId
            },
            onSuccess: function(json) {
                if (json.status === 'success') {
                    ...
                    json.subjects.forEach(function(subject) {
                        selectElement.append(`<option value="${subject.subject_id}">${subject.name}</option>`);
                    });
                } else {
                    alert(json.message);
                }
    ...
    // Fetch subjects by class_id
    function fetchSubjectsByClass(classId, callback) {
        ajaxDebug({
            url: 'students/functions.php',
            method: 'POST',
            data: {
    ...
    // ================================================
    // CUSTOM GROUPS – FULL SCRIPT WITH VIEW STUDENTS MODAL
    // ================================================
        ...
        ajaxDebug({
            ...
            onSuccess: function(json) {
                if (json.status === 'success') {
                    ...
                    alert(json.message || 'Failed to load subjects');
                }
            }
        });
    }
    ...
    // Fetch students
    function fetchStudentsByClass(classId, callback) {
        ajaxDebug({
            url: 'students/functions.php',
            method: 'POST',
            data: {
    ...
    // Render subjects checkboxes (used in add & edit)
    function renderSubjects(containerId, subjects, selectedIds = []) {
        const $container = $(`#${containerId}`).empty();
        if (!subjects.length) {
            $container.html('<p class="text-muted text-center py-3">No subjects available</p>');
            return;
        }
        subjects.forEach(sub => {
            const checked = selectedIds.includes(sub.subject_id) ? 'checked' : '';
            $container.append(`
            <div class="col">
                <div class="form-check border rounded px-3 py-2">
                    <input class="form-check-input" type="checkbox" name="subject_ids[]" value="${sub.subject_id}" id="${containerId}_s_${sub.subject_id}" ${checked}>
                    <label class="form-check-label" for="${containerId}_s_${sub.subject_id}">${sub.name}</label>
                </div>
            </div>
        `);
        });
    ...
    $('#manageCustomGroupsModal').on('show.bs.modal', function() {
        ajaxDebug({
            ...
            method: 'POST',
            data: {
                action: 'get_custom_groups'
            },
            onSuccess: function(json) {
                const $tbody = $('#customGroupsTable tbody').empty();
                if (json.status !== 'success' || !json.groups?.length) {
                    $tbody.html('<tr><td colspan="6" class="text-center py-4 text-muted">No custom groups created yet</td></tr>');
                    return;
                }
    ...
    $(document).on('click', '.view-group-students', function() {
        const groupId = $(this).data('group-id');
        const groupName = $(this).data('group-name');

        $('#viewGroupNameDisplay').text(groupName);

        ajaxDebug({
            url: 'students/functions.php',
            method: 'POST',
            data: {
                action: 'get_students_in_group',
                group_id: groupId
            },
            onSuccess: function(json) {
                const $list = $('#viewGroupStudentsList').empty();
                const $noMsg = $('#noStudentsMessage');
                ...
                $('#viewGroupStudentsModal').modal('show');
            }
        });
    });
    ...
    $('#addGroupClassSelect').on('change', function() {
        const cid = $(this).val();
        if (!cid) return $('#addGroupSubjectsSection, #addGroupStudentsSection').hide();

        fetchSubjectsByClass(cid, subs => renderSubjects('addGroupSubjectsList', subs, []));
        fetchStudentsByClass(cid, studs => renderStudents('addGroupStudentsList', studs, []));
        $('#addGroupSubjectsSection, #addGroupStudentsSection').show();
    });

    // Add submit
    $('#addCustomGroupForm').on('submit', function(e) {
        e.preventDefault();

        const subjCount = $('#addGroupSubjectsList input:checked').length;
        const studCount = $('#addGroupStudentsList input:checked').length;

        if (subjCount === 0) return $('#addSubjectsError').show();
        if (studCount === 0) return $('#addStudentsError').show();

        $('#addSubjectsError, #addStudentsError').hide();

        ajaxDebug({
            url: 'students/functions.php',
            method: 'POST',
            data: $(this).serialize() + '&action=add_custom_group',
            onSuccess: function(json) {
                alert(json.message);
                if (json.status === 'success') {
                    $('#addCustomGroupModal').modal('hide');
                    location.reload();
                }
            }
        });
    ...
    // Edit class change
    $('#editGroupClassSelect').on('change', function() {
        const cid = $(this).val();
        if (!cid) return;

        fetchSubjectsByClass(cid, subs => renderSubjects('editGroupSubjectsList', subs, []));
        fetchStudentsByClass(cid, studs => renderStudents('editGroupStudentsList', studs, []));
    });

    // Edit submit
    $('#editCustomGroupForm').on('submit', function(e) {
        e.preventDefault();

        const subjCount = $('#editGroupSubjectsList input:checked').length;
        const studCount = $('#editGroupStudentsList input:checked').length;

        if (subjCount === 0) return $('#editSubjectsError').show();
        if (studCount === 0) return $('#editStudentsError').show();

        $('#editSubjectsError, #editStudentsError').hide();

        ajaxDebug({
            url: 'students/functions.php',
            method: 'POST',
            data: $(this).serialize() + '&action=edit_custom_group',
            onSuccess: function(json) {
                alert(json.message);
                if (json.status === 'success') {
                    $('#editCustomGroupModal').modal('hide');
                    location.reload();
                }
            }
        });
